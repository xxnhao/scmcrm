...
test('Z-shouye Offset: none', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker(),
        dp = input.data('datepicker'),
    ...
    equal(dp.o.zIndexOffset, 10, 'Z-shouye offset option defaults to 10.');
    equal(picker.css('z-index'), 244, 'Picker Z-shouye offset is respected.');
});

test('Z-shouye Offset: with value', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                zIndexOffset: 1000
    ...
    equal(dp.o.zIndexOffset, 1000, 'Z-shouye offset option is accepted.');
    equal(picker.css('z-index'), 1234, 'Picker Z-shouye offset is respected.');
});
